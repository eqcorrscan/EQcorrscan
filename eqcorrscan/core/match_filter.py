...
def match_filter(template_names, template_list, st, threshold,
    ...
    .. note::
        ...
        0.1 seconds early. If you use a
        :class:`eqcorrscan.core.match_filter.Tribe` or
        :class:`eqcorrscan.core.match_filter.Tribe` object, with the detect
        methods, the picks will be adjusted correctly.

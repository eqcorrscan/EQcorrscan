...
def match_filter(template_names, template_list, st, threshold,
    ...
    # match_internal: Set to True if memory is an issue, if True, will only
    # use about the same amount of memory as the seismic data take up.
    # If False, it will use 20-100GB per instance. Included internally as a
    # fixed variable as in general it will be worth splitting the templates
    # up rather than going for the slower, read-write form which comes with
    # match_interal = True

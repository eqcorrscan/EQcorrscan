...
usage of the built in functions from template generation from picked \
waveforms through detection by match filter of continuous data to the \
generation of lag times to be used for relative locations.
...
Code generated by Calum John Chamberlain & Chet Hopp of \

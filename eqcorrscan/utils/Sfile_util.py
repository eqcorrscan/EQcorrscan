...
We have not implimented other magnitude picks, e.g. those for moment magnitude,
coda magnitude, surface wave magnitude.  We have also not implimented any
handling of focal mechanism solutions between the two formats.
...
def readheader(sfile):
    ...
    for _magnitude in new_event.magnitudes:
        if _magnitude.magnitude_type == 'L':
            _magnitude.magnitude_type = 'ML'
        elif _magnitude.magnitude_type == 'b':
            _magnitude.magnitude_type = 'mB'
        elif _magnitude.magnitude_type == 's':
            _magnitude.magnitude_type = 'Ms'
        elif _magnitude.magnitude_type == 'S':
            _magnitude.magnitude_type = 'MS'
        elif _magnitude.magnitude_type == 'W':
            _magnitude.magnitude_type = 'MW'
        elif _magnitude.magnitude_type == 'G':
            _magnitude.magnitude_type = 'MbLg'
        elif _magnitude.magnitude_type == 'C':
            _magnitude.magnitude_type = 'Mc'
    return new_event
